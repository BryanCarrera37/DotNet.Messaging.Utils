...
namespace BryanCM.Messaging.Utils.UnitTests
{
    public class DependencyInjectionTests
    {
        ...
        public void ConfigureRabbitMQ_ShouldConfigureDefaultPublisher()
        {
            ...
            Assert.Equal("BryanCM.Messaging.Utils.Services", publisher.GetType().Namespace);
            Assert.Contains("BryanCM.Messaging.Utils", publisher.GetType().Assembly.FullName);
        }
